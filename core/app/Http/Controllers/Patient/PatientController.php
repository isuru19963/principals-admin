...
class PatientController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $new_appointment = Appointment::where('patient',Auth::guard('patient')->user()->id)->where('try',1)->where('d_status',0)->where('is_complete',0)->whereHas('relationPatient', function ($query) {
            $query->where('status',1);
        })->count();

        $appointment_done = Appointment::where('patient',Auth::guard('patient')->user()->id)->where('try',1)->where('is_complete',1)->where('p_status',1)->where('d_status',0)->latest()->whereHas('relationPatient', function ($query) {
            $query->where('status',1);
       })->count();

        $total_appointment = Appointment::where('patient',Auth::guard('patient')->user()->id)->where('try',1)->where('d_status',0)->latest()->where('is_complete',0)->whereHas('relationPatient', function ($query) {
            $query->where('status',1);
       })->count();

        return   view('patient.dashboard',compact('page_title','new_appointment','appointment_done','total_appointment'));
    }
    public function profile()
    {
        $page_title = 'Profile';
        $staff = Auth::guard('patient')->user();
        return view('patient.profile', compact('page_title', 'staff'));
    }
    ...
    public function profileUpdate(Request $request)
    {
        ...
        return redirect()->route('patient.profile')->withNotify($notify);
    }
    ...
    public function password()
    {
        ...
        $staff = Auth::guard('patient')->user();
        return view('patient.password', compact('page_title', 'staff'));
    }
    ...
    public function passwordUpdate(Request $request)
    {
        ...
        return redirect()->route('patient.password')->withNotify($notify);
    }

    public function createAppointment(){
        $page_title = 'Create Appoiment';
        $doctors = Doctor::where('status',1)->latest()->get();
        return view('patient.appointment.create-appointment',compact('page_title','doctors'));
    }
    ...
    public function appointmentDetails(Request $request){
        ...
        if ($doctor->status == 0) {
            ...
            return redirect()->route('patient.appointment.create')->withNotify($notify);
        }
        ...
        return view('patient.appointment.book-appointment',compact('doctor','page_title','available_date'));
    }
    ...
    public function allAppointment(){
        ...
        $appointments = Appointment::where('patient',Auth::guard('patient')->user()->id)->where('try',1)->where('is_complete',0)->where('d_status',0)->whereHas('relationPatient', function ($query) {
            $query->where('status',1);
       })->latest()->paginate(getPaginate());
        $empty_message = 'No Appointment Found';
        return view('patient.appointment.appointment',compact('page_title','appointments','empty_message'));
    }
    ...
    public function appointmentDone(){
        ...
        $appointments = Appointment::where('patient',Auth::guard('patient')->user()->id)->where('try',1)->where('is_complete',1)->where('d_status',0)->whereHas('relationPatient', function ($query) {
            $query->where('status',1);
       })->latest()->paginate(getPaginate());
    ...
    public function appointmentRemove($id){
        $appointment = Appointment::where('patient',Auth::guard('patient')->user()->id)->findOrFail($id);
    ...
    public function appointmentTrashed(){
        ...
        $appointments = Appointment::where('patient',Auth::guard('patient')->user()->id)->where('d_status',1)->whereHas('relationPatient', function ($query) {
            $query->where('status',1);
       })->latest()->paginate(getPaginate());
        $empty_message = 'No Trashed Appointment Found';

        return view('patient.appointment.trashed-appointment',compact('page_title','appointments','empty_message'));
    }
    ...
    public function show2faForm()
    {
        ...
        return view('patient.twofactor', compact('page_title', 'secret', 'qrCodeUrl', 'prevcode', 'prevqr'));
    }
