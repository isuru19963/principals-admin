                    ...
                    <table class="default-data-table table ">
                        ...
                        <tbody class="list">
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Institution')">{{ Str::limit(($item->book_name),20) }}</td>
                                <td data-label="@lang('Disease')">{{ Str::limit((strip_tags($item->description)),50) }}</td>
                                <td data-label="@lang('Disease')">{{ Str::limit((strip_tags($item->author)),50) }}</td>
                                <td data-label="@lang('Disease')">Rs. {{ Str::limit((strip_tags($item->price )),50) }}</td>
                                <td data-label="@lang('Period')"> <img src="{{asset('assets/books/'.$item->cover_page )}}" height="100px" width="100px" alt="tag"></td>
                                ...
                                <td data-label="@lang('Action')">
                                    ...
                                    <a href="#" class="icon-btn btn--danger removeBtn" data-route="{{ route('admin.books.remove',$item->id) }}" data-toggle="tooltip" data-original-title="Remove"><i class="la la-trash"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
                    ...
                    <div class="modal-body">
                        <form id="message-submit-form"  >
                            ...
                            <div class="form-group">
                                <label class="text-muted">@lang('Book Title')</label>
                                <input type="text" name="book_name"  class="form-control " required>
                            </div>
                            <div class="form-group">
                                <label class="text-muted">@lang('Book Description')</label>
                                <textarea name="description" id="description" class="form-control"  rows="1"></textarea>
                            </div>
                            <div class="form-group">
                                <label class="text-muted">@lang('Book Author')</label>
                                <input type="text" name="author" placeholder="@lang('Dr.Devinda De Silva')" class="form-control " required>
                            </div>
                            <div class="form-group">
                                <label class="text-muted">@lang('Book Price(Rs.)')</label>
                                <input type="text" name="price" placeholder="@lang('1500')" class="form-control " required>
                            </div>
                        ...
                        <div class="form-group">
                            <label class="text-muted">@lang('Attachments')</label><br>
                            (<label class="text-muted"><span style="color: red;">@lang('Firstly Select Book Cover page image after that select Book PDF')</span></label>)
                            <form method="post" action="{{route('admin.books.upload')}}"
