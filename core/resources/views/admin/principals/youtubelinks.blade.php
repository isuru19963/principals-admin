                        ...
                        <tbody class="list">
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Action')">
                                    {{-- <a href="#" class="icon-btn  updateBtn" data-route="{{ route('admin.articles.update',$item->id) }}" data-resourse="{{$item}}" data-toggle="modal" data-target="#updateBtn" ><i class="la la-pencil-alt"></i></a> --}}
                                    <a href="#" class="icon-btn  updateBtn" data-route="{{ route('admin.youtube.update',$item->id) }}" data-resourse="{{$item}}" data-toggle="modal" data-target="#updateBtn"><i class="la la-pencil-alt"></i></a>
                                    <a href="#" class="icon-btn btn--danger removeBtn" data-route="{{ route('admin.youtube.remove',$item->id) }}" data-toggle="tooltip" data-original-title="Remove"><i class="la la-trash"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">@lang('Add Youtube Video Details')</h5>
...
<div id="updateBtn" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"> @lang('Update Youtube Details')</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="" class="edit-route" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text"class="form-control title" placeholder="@lang('Example : Dental')" name="title" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="doctor_id"  required>
                          ...
                          <div class="form-group">
                            <label class="text-muted" aria-placeholder="gpBpG9l72aA">@lang('Yotube Video Link ID (Follow the image)')</label>
                            <img src="{{getImage('assets/images/youtubehint.jpg')}}">
                            <label class="text-muted" aria-placeholder="gpBpG9l72aA">@lang('Change Onlye Video ID')</label>
                            &nbsp;
                            {{-- <textarea name="link" id="link" class="form-control"  rows="2"></textarea> --}}
                            <input type="text"class="form-control youtubelink"  name="youtubelink" required>
                            {{-- <input type="text" name="" placeholder="gpBpG9l72aA" class="form-control " required> --}}
                            </div>
    ...
    <script>
        ...
        (function ($) {
            ...
            $('.updateBtn').on('click', function () {
                ...
                $('.details').val(resourse.description);
                $('.youtubelink').val(resourse.youtube_link);
