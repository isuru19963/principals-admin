                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="image-upload mt-2">
                                        <div class="thumb">
                                            <div class="profilePicPreview" hidden id="profilePicPreview">
                                            ...
                                            <div class="avatar-edit">
                                                <input type="file" class="profilePicUpload" name="image" id="profilePicUpload1" accept=".png, .jpg, .jpeg" onchange="$('#profilePicPreview').prop('hidden',false)">
