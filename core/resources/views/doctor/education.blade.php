                        ...
                        <tbody class="list">
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Action')">
                                    <a href="#" class="icon-btn  updateBtn" data-route="{{ route('doctor.education.update',$item->id) }}" data-resourse="{{$item}}" data-toggle="modal" data-target="#updateBtn"><i class="la la-pencil-alt"></i></a>
                                    <a href="#" class="icon-btn btn--danger removeBtn" data-route="{{ route('doctor.education.remove',$item->id) }}" data-toggle="tooltip" data-original-title="Remove"><i class="la la-trash"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
