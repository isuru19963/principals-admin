...
<div class="page-wrapper default-version">
    <div class="form-area bg_img" data-background="{{asset('assets/doctor/images/1.jpg')}}">
        <div class="form-wrapper">
            ...
            <h4>@lang('Your Mobile Number'): <strong>{{Auth::guard('doctor')->user()->mobile}}</strong></h4>
            <form action="{{route('doctor.verify_sms')}}" method="POST" class="cmn-form mt-30">
                @csrf
                ...
                <div class="form-group d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{route('doctor.send_verify_code')}}?type=phone" class="text-muted text--small">@lang('Try to send
                        again')</a>
                </div>
