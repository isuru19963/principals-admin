            ...
            <li class="dropdown">
                <button type="button" class="" data-toggle="dropdown" data-display="static" aria-haspopup="true"
                    ...
                    <span class="navbar-user">
                        <span class="navbar-user__thumb"><img src="{{ getImage(imagePath()['staff']['path'].'/'. auth()->guard('patient')->user()->image,imagePath()['staff']['size']) }}"
                                alt="@lang('image')"></span>

                        <span class="navbar-user__info">
                        <span class="navbar-user__name">{{auth()->guard('patient')->user()->username}}</span>
                        </span>
