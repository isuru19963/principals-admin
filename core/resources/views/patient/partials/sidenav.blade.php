    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{menuActive('patient.appointment.create')}}">
                    <a href="{{route('patient.appointment.create')}}" class="nav-link ">
                        <i class="menu-icon far fa-handshake"></i>
                        <span class="menu-title">@lang('Create Appointment')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('patient.appointments.all')}}">
                    <a href="{{route('patient.appointments.all')}}" class="nav-link ">
                        <i class="menu-icon fas fa-handshake"></i>
                        <span class="menu-title">@lang('New Appointment')</span>
                        @if($patient_new_appointments_count)
                            <span
                                class="menu-badge pill bg--primary ml-auto">{{$patient_new_appointments_count}}</span>
                        @endif
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('patient.done.appointment')}}">
                    <a href="{{route('patient.done.appointment')}}" class="nav-link ">
                        <i class="menu-icon fas fa-check-square"></i>
                        <span class="menu-title">@lang('Appointment Done')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('patient.appointments.trashed')}}">
                    <a href="{{route('patient.appointments.trashed')}}" class="nav-link ">
                        <i class="menu-icon la la-trash"></i>
                        <span class="menu-title">@lang('Trashed')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('patient.profile')}}">
                ...
                <li class="sidebar-menu-item {{menuActive('patient.twofactor*')}}">
                    <a href="{{ route('patient.twofactor') }}" class="nav-link ">
